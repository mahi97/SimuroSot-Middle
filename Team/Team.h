...
2018/12/21      0.3             MohammadMahdi Rahimi       Modify
</PRE>
******************************************************************************* 
...
#else
#define TEAM_API __declspec(dllimport)
...
/* MUST BE IMPLEMENTED */
extern "C" TEAM_API void Create ( Environment *env );   
extern "C" TEAM_API void Strategy ( Environment *env );
extern "C" TEAM_API void Destroy ( Environment *env ); 
